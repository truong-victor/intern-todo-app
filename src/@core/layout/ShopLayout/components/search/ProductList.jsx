...
import CoreProduct from "../../../../components/productItem/CoreProduct";
function ProductList() {
  ...
  return (
    <div className="">
      {query ? (
        <div className="inline-block py-2 border-b-2 border-[#333]">
          <h1 className="inline-block text-xl text-[#333] font-semibold ">
            KẾT QUẢ TÌM KIẾM : {query?.toLocaleUpperCase()}
          </h1>
