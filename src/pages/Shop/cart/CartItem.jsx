...
function CartItem(props){
    const {removeItem, toggleCheckedItem, isCheckedAll} = useCartContext();
    const {item} = props;
    ...
    return (
      <div className="py-[18px] flex justify-between border-b-[1px] border-gray-500">
        ...
        <div className="w-[140px]">
          <CartNumberInput id={item?.id} newQuantity={newQuantity} setNewQuantity={setNewQuantity} purchaseQuantity = {item?.purchaseQuantity}/>
