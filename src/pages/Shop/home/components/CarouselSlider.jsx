    ...
    return (
      <div>
        <Slider className="mt-[-50px]"  ref={slider => (this.slider = slider)} {...settings}>
          <div >
            <img className="rounded-lg" src="/images/home/05_Octb516d2fb3bffbaacac193bdc0e288add.webp" alt="" />
          </div>
          <div>
              <img className="rounded-lg" src="/images/home/15_Nov2b6721be0497612d5ecdaf01507a0d69.webp" alt="" />
          </div>
          <div>
            <img className="rounded-lg" src="/images/home/01_Nov489aa80faeaf8deb3b8d006f43798985.webp" alt="" />
          </div>
        </Slider>
      </div>
    );
